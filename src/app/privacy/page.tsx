    ...
    >
      ...
      <LegalSection title="What information we collect">
        ...
        <p>
          ...
          app, such as split-bill entries or machine-tracking records. That data
          is kept in a hosted Postgres database operated by Supabase. If the app
          is run without a database configured, it stores that data locally in
      ...
      <LegalSection title="Data retention and deletion">
        <p>
          ...
          the sign-in experience working. Content you create in the tools is kept
          in the hosted database until you delete it from within the app or ask
          us to remove it. Where the app has fallen back to browser storage, that
          data can usually be removed by clearing site data from your browser.
        </p>
        <p>
